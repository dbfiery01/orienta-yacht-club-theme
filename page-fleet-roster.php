...
<section class="section">
	<div class="container page-content">
		...
		<?php else : ?>
			...
			<p class="roster-pdf"><a href="<?php echo esc_url( home_url( '/wp-content/uploads/2026/01/2025-Fleet-Roster-Final-Edition.pdf' ) ); ?>" target="_blank" rel="noopener">&#128196; <?php esc_html_e( 'Download the full Fleet Roster (PDF)', 'orienta-yacht-club' ); ?> &#8599;</a></p>
